...
bmt = read.csv(file = 'C:/Users/Esteban Guerrero/Documents/Data Science EGB/Proyecto Final/BmtSupplierList2.csv', sep=',', stringsAsFactors = FALSE)

krl = read.csv(file = 'C:/Users/Esteban Guerrero/Documents/Data Science EGB/Proyecto Final/KrlSupplierList2.csv', sep=',', stringsAsFactors = FALSE)

srn = read.csv(file = 'C:/Users/Esteban Guerrero/Documents/Data Science EGB/Proyecto Final/SrnSupplierList2.csv', sep=',', stringsAsFactors = FALSE)

strth = read.csv(file = 'C:/Users/Esteban Guerrero/Documents/Data Science EGB/Proyecto Final/StrthSupplierList2.csv', sep=',', stringsAsFactors = FALSE)
...
```{r}
fit <- kmeans(pilotscaled, centers=3, iter.max = 1000)
...
According to cut point between specificity and sensibility curves and confirming with the ROC curve, the optimal probability threshdold is 0.028

Calculate RMSE

```{r}
estimacion = data.frame(validacionpilot$eCat_Flag, prediccion1)
estimacion$estimado = ifelse(estimacion$prediccion1 >= 0.028, 1, 0)
str(estimacion)
...
confusion$valoracion = ifelse(confusion$prediccion1 >= 0.028, 1, 0)
